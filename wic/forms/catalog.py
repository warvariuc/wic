...
class CatalogForm(WForm):
    ...
    def createTableView(self):
        ...
        #print(tableView.editTriggers())
        #tableView.setEditTriggers(tableView.DoubleClicked | tableView.EditKeyPressed)
        #tableView.activated.connect(lambda : print('asdf'))
        #tableView.verticalHeader().setDefaultSectionSize(...)
        #tableView.resizeColumnsToContents()
        tableView.installEventFilter(self)
        tableView.doubleClicked.connect(self.openForm)
    ...
    def showContextMenu(self, coord):
        if not hasattr(self, 'menu'): # create the context menu for Message Window
            self.menu = QtGui.QMenu(self.tableView)
        ...
        self.menu.popup(self.tableView.mapToGlobal(coord))
