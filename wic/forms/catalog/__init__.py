...
class CatalogForm(WForm):
    ...
    def createToolbar(self):
        ...
        menu = Bunch()
        menu.createItem = createAction(toolbar, 'Create new item', self.createItem, 'Insert', ':/icons/fugue/card--plus.png')
        menu.editItem = createAction(toolbar, 'Edit selected item', self.editItem, 'Enter', ':/icons/fugue/card--pencil.png')
        menu.deleteItem = createAction(toolbar, 'Delete selected item', self.deleteItem, 'Delete', ':/icons/fugue/card--minus.png')   
