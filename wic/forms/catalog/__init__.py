    ...
    def fillItemFromForm(self):
        ...
        for field in catalogItem.__class__:
            ...
            if widget:
                ...
                if isinstance(field, orm.IdField) and not fieldValue:
...
class CatalogForm(forms.WForm):
    ...
    def setupToolbar(self, toolbar):
        ...
        menu = Bunch()
        menu.createItem = menus.createAction(
            toolbar, 'Create new item', self.createItem, 'Insert', ':/icons/fugue/plus.png')
        menu.editItem = menus.createAction(
            toolbar, 'Edit selected item', self.editItem, 'Enter', ':/icons/fugue/pencil.png')
        menu.deleteItem = menus.createAction(
            toolbar, 'Delete selected item', self.deleteItem, 'Delete', ':/icons/fugue/cross.png')
            ...
            if event.modifiers() in (QtCore.Qt.NoModifier, QtCore.Qt.KeypadModifier):
                ...
                if key in (QtCore.Qt.Key_Enter, QtCore.Qt.Key_Return):
                    ...
                    tableView.setCurrentIndex(tableView.model().index(
                        tableView.model().rowCount(None) - 1, currentIndex.column()))
                    return True
    ...
    def onTableViewContextMenuRequested(self, coord):
        ...
        menus.addActionsToMenu(
            menu, (self.menu.createItem, self.menu.editItem, self.menu.deleteItem))
