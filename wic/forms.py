...
class WForm(QtGui.QDialog):
    ...
    def __init__(self):
        ...
        try:
            ...
            wic.mainWindow.messagesWindow.printMessage(traceback.format_exc())
...
def openCatalogItemForm(catalogItem, FormClass= None):
    ...
    if FormClass is None:
        ...
        # TODO: if user form not present - take CatalogItemForm with autogenerated widgets
    
    assert issubclass(FormClass, CatalogItemForm), 'This is not a CatalogItemForm'
    openForm(FormClass, catalogItem)
...
class CatalogForm(WForm):
    ...
    def __init__(self, catalogModel):
...
def openCatalogForm(catalogModel, FormClass= None):
    assert isinstance(catalogModel, type) and issubclass(catalogModel, orm.Model), 'Pass a model class.'
    if FormClass is None:
    ...
    openForm(FormClass, catalogModel)
